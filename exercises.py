...
EXERCISE_CATEGORIES = [
    ...
    ('strength_lower', {
        ...
        },
        {
            ...
            'setup': {'en': 'Supine, knees bent, feet flat.', 'cn': '\u4ef0\u5367\uff0c\u5c48\u819d\uff0c\u53cc\u811a\u7740\u5730\u3002'},
            'action': {'en': 'Squeeze glutes, lift hips, lower slowly.', 'cn': '\u6536\u7d27\u81c0\u808c\uff0c\u62ac\u9ad8\u9acb\u90e8\uff0c\u7f13\u6162\u4e0b\u843d\u3002'},
            'dose': '10 \u00d7 2',
    ...
    ('strength_upper', {
    ...
    }, [
        {
            ...
            'action': {'en': 'Bend elbows, bring chest to wall, push back.', 'cn': '\u5c48\u8098\uff0c\u80f8\u90e8\u9760\u5899\uff0c\u518d\u63a8\u56de\u3002'},
            'dose': '10\u201315 \u00d7 2',
        ...
        },
        {
            ...
            'setup': {'en': 'Seated, band around feet, elbows in.', 'cn': '\u5750\u4f4d\uff0c\u5f39\u529b\u5e26\u7ed5\u8fc7\u53cc\u811a\uff0c\u8098\u8d34\u8eab\u3002'},
            'action': {'en': 'Pull band to waist, squeeze shoulder blades.', 'cn': '\u62c9\u5f39\u529b\u5e26\u81f3\u8170\u90e8\uff0c\u6536\u7d27\u80a9\u80db\u9aa8\u3002'},
            'dose': '10\u201312 \u00d7 2',
            'progress': {'en': 'Stiffer band', 'cn': '\u66f4\u7c97\u5f39\u529b\u5e26'},
            'regress': {'en': 'Lighter band', 'cn': '\u66f4\u8f7b\u5f39\u529b\u5e26'},
            'safety': {'en': 'Upright posture, no rounding', 'cn': '\u4fdd\u6301\u633a\u76f4\uff0c\u52ff\u5f2f\u8170'},
        },
        {
        ...
        {
            'name': {'en': 'Chair Triceps Dip', 'cn': '\u5ea7\u6905\u80b1\u4e09\u5934\u808c\u5c48\u4f38'},
            'target': {'en': 'Triceps', 'cn': '\u80b1\u4e09\u5934\u808c'},
            'setup': {'en': 'Seated at chair edge, hands gripping seat edge.', 'cn': '\u5750\u4e8e\u6905\u8fb9\uff0c\u53cc\u624b\u6293\u4f4f\u5ea7\u6905\u8fb9\u7f18\u3002'},
            'action': {'en': 'Slide hips forward, bend elbows 5\u201310 cm, push up.', 'cn': '\u9acb\u90e8\u524d\u79fb\uff0c\u5c48\u8098 5\u201310 cm\uff0c\u518d\u63a8\u8d77\u3002'},
            'dose': '8\u201310 \u00d7 2',
    ...
    ('balance', {
        ...
        },
        {
            ...
            'dose': '8 / side \u00d7 2',
            'progress': {'en': 'Further reach', 'cn': '\u66f4\u8fdc\u89e6\u591f'},
            'regress': {'en': 'Shorter reach', 'cn': '\u66f4\u8fd1\u89e6\u591f'},
            'safety': {'en': 'Opposite hand on chair', 'cn': '\u53e6\u4e00\u624b\u6276\u6905'},
        },
        {
            'name': {'en': 'Side Step', 'cn': '\u4fa7\u6b65\u8d70'},
            'target': {'en': 'Dynamic balance', 'cn': '\u52a8\u6001\u5e73\u8861'},
            'setup': {'en': 'Stand, feet hip-width, near wall.', 'cn': '\u7ad9\u7acb\uff0c\u53cc\u811a\u4e0e\u9acb\u540c\u5bbd\uff0c\u9760\u8fd1\u5899\u9762\u3002'},
    ...
    ('flexibility', {
        ...
        },
        {
            ...
            'action': {'en': 'Hinge forward from hips, reach for toes.', 'cn': '\u4ece\u9acb\u90e8\u524d\u5c48\uff0c\u624b\u89e6\u811a\u5c16\u3002'},
            'dose': 'Hold 20\u201330 s \u00d7 2 / leg',
        ...
        },
        {
            ...
            'setup': {'en': 'Standing lunge, back knee straight.', 'cn': '\u5f13\u6b65\u7ad9\u7acb\uff0c\u540e\u817f\u819d\u4f38\u76f4\u3002'},
            'action': {'en': 'Tuck pelvis, shift weight forward gently.', 'cn': '\u6536\u9aa8\u76c6\uff0c\u8f7b\u8f7b\u524d\u79fb\u91cd\u5fc3\u3002'},
            'dose': 'Hold 20\u201330 s \u00d7 2 / leg',
            'progress': {'en': 'Deeper lunge', 'cn': '\u66f4\u6df1\u5f13\u6b65'},
    ...
    ('aerobic', {
    ...
    }, [
        {
            ...
            'setup': {'en': 'Stand or sit, upright posture.', 'cn': '\u7ad9\u7acb\u6216\u5750\u4f4d\uff0c\u4fdd\u6301\u633a\u76f4\u3002'},
            'action': {'en': 'Alternate lifting knees to hip height.', 'cn': '\u4ea4\u66ff\u62ac\u819d\u81f3\u9acb\u9ad8\u5ea6\u3002'},
            'dose': '1\u20133 min \u00d7 2\u20133',
        ...
        },
        {
            ...
            'target': {'en': 'Cardiovascular', 'cn': '\u5fc3\u80ba\u8010\u529b'},
            'setup': {'en': 'Stationary bike, seat at hip-knee level.', 'cn': '\u56fa\u5b9a\u8e0f\u8f66\uff0c\u5ea7\u4f4d\u8c03\u81f3\u9acb\u819d\u540c\u9ad8\u3002'},
